...
public static class ComponentCodeEmitter
{
    ...
    var assumeResolvable = availableNamespaces != null; // if we emit using directives, we can assume simple names resolve
    sb.Append(RenderTreeBuilderEmitter.EmitBuildRenderTree(htmlContent, metadata, componentTypeMap, indentLevel: 2, assumeComponentsResolvable: assumeResolvable));
