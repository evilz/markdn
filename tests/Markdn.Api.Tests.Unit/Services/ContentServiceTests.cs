...
{
    private static ContentService CreateService(Mock<IContentRepository> mockRepository)
    {
        var mockCache = new Mock<IContentCache>();
        var mockLogger = new Mock<ILogger<ContentService>>();
        return new ContentService(mockRepository.Object, mockCache.Object, mockLogger.Object);
    }
